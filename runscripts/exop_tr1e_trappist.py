...
trappist1f = exo.Model(workdir="tr1e_exo",modelname="tr1e_exo",ncpus=32,resolution="T21",outputtype=".nc")

trappist1f.configure(startemp=2600.0, starspec='/glade/u/home/hchen/2600_4.0_BT-Settl.dat',flux=996.0,   eccentricity=0.,obliquity=0.,fixedorbit=True,synchronous=True,substellarlon= 180,rotationperiod=6.1,radius=0.94,gravity=7.,aquaplanet=True,pN2=1.,pCO2=0.2,ozone=False,mldepth= 50, timestep=60.0,physicsfilter="gp|exp|sp")
...
for i in range(400):
    ...
    trappist1f.configure(startemp=2600.0,starspec='/glade/u/home/hchen/2600_4.0_BT-Settl.dat', flux=996.0,   eccentricity=0.,obliquity=0.,fixedorbit=True,synchronous=True,substellarlon= subp,rotationperiod=rotp,radius=0.94,gravity=7.,aquaplanet=True,pN2=1.,pCO2=0.2,mldepth= 50,ozone=False, timestep=60.0,physicsfilter="gp|exp|sp",restartfile="/glade/u/home/hchen/tr1e_exo")
    trappist1f.exportcfg()
    trappist1f.run(years=1,crashifbroken=True)
    trappist1f.finalize(outputdir='/glade/scratch/hchen/plasim_runs/', allyears=True, keeprestarts=True, clean=False)
    
    for filename in glob.glob("/glade/u/home/hchen/tr1e_exo/*nc"):
       os.remove(filename)
